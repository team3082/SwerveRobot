...
public class RobotConfig {
    ...
    public static void init() {
        try{
            ...
            // Telemetry.log(Telemetry.Severity.CRITICAL, "** Parsing error" + ", line " + err.getLineNumber () + ", uri " + err.getSystemId ());
            // Telemetry.log(Telemetry.Severity.CRITICAL, " " + err.getMessage());
