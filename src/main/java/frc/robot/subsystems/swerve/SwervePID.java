...
public class SwervePID {
    ...
    /**
     * Enum representing various desired states of SwervePID.
     */
    public enum PIDType {
        /** Should PID be updating nothing? */
        NONE,
        /** Should PID only be updating our velocity? */
        VELOCITY,
        /** Should PID only be updating our rotation? */
        ROTATION,
        /** Should PID be updating both our velocity and rotation? */
        ALL
    }
