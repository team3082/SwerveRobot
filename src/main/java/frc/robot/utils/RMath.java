...
public class RMath {
    ...
    /**
     * Smooth the joystick input of the right-most stick.
     * @param val The value of the joystick
     * @return The normalized version of this input
     */
    ...
    /**
     * Smooth the joystick output of the left-most stick.
     * @param dir The vector constructed from the axes of the joystick
     * @return The normalized version of this vector, multiplied & clamped by the magnitude
     */
